...
// 请求方法一定要填
export const urls: { [key: string]: Request; } = {
    // 登录
...
//     uploadImage: baseUrl + 'file/uploadFile', // 图片上传接口
...
//     // 会员相关
//     memberFrozen: baseUrl + 'member/statusToCommon', // 获取所有用户接口
//     getAllMember: baseUrl + 'member/getAllMember', // 获取所有用户接口
//     innerToCommon: baseUrl + 'member/innerToCommon', // 获取所有用户接口
//     updateMember: baseUrl + 'member/updateMember', // 更新用户信息
//     isOfficial: baseUrl + 'member/isOfficialToCommon', // 是否官方账号
// };
